...
view dx {
	...
	zone "." IN {
        ...
        zone "uplooking.com" {
                type master;
                file "/var/named/uplooking.com.dx";
         };
...
view wt {
	...
	zone "." IN {
        ...
        zone "uplooking.com" {
                type master;
                file "/var/named/uplooking.com.wt";
         };
        include "/etc/named.rfc1912.zones";
};
...
view others {
	...
	zone "." IN {
        ...
        zone "uplooking.com" {
                type master;
                file "/var/named/uplooking.com.other";
         };
        include "/etc/named.rfc1912.zones";
};
...
" > /var/named/uplooking.com.other
#set server
chown named.named uplooi*
